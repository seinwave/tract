...
const Chart9 = () => {
  ...
  return (
    <div>
      <div className="text-dark font-size-18 font-weight-bold mb-1">Outstanding tickets</div>
      <div className="text-gray-6 mb-2">By priority</div>
