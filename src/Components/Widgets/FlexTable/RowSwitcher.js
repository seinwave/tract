    ...
    default:
      ...
      return data
        .filter((d) => {
          ...
          return (
            d.project_id.toString().toLowerCase().includes(search.toLowerCase()) ||
            ...
            d.project_description.toLowerCase().includes(search.toLowerCase()) ||
            d.project_type.toString().toLowerCase().includes(search.toLowerCase()) ||
            d.project_client.toString().toLowerCase().includes(search.toLowerCase()) ||
            d.user_full_name.toString().toLowerCase().includes(search.toLowerCase()) ||
            (d.ticket_title ? d.ticket_title.toString().toLowerCase() : "").includes(search.toLowerCase())
          );
        })
        .map((d) => {
          return (
      ...
      case "tickets": 
        ...
        return data
          .filter((d) => {
            ...
            return (
              d.ticket_id.toString().toLowerCase().includes(search.toLowerCase()) ||
              d.ticket_title.toString().toLowerCase().includes(search.toLowerCase()) ||
              d.ticket_description.toString().toLowerCase().includes(search.toLowerCase()) ||
              d.ticket_type.toString().toLowerCase().includes(search.toLowerCase()) ||
              d.ticket_status.toString().toLowerCase().includes(search.toLowerCase()) ||
              d.ticket_priority.toString().toLowerCase().includes(search.toLowerCase()) ||
              d.user_full_name.toString().toLowerCase().includes(search.toLowerCase()) ||
      ...
      return data
        .filter((d) => {
          return (
            ...
            d.user_role.toString().toLowerCase().includes(search.toLowerCase()) ||
            d.user_full_name.toLowerCase().includes(search.toLowerCase()) ||
            d.user_email.toString().toLowerCase().includes(search.toLowerCase()) ||
            (d.ticket_title ? d.ticket_title.toString().toLowerCase() : "").includes(search.toLowerCase()) ||
            (d.project_name ? d.project_name.toString().toLowerCase() : "").includes(search.toLowerCase())
          );
        })
        .map((d) => {
          console.log(d);
    ...
    case "expenses":
      ...
      return data
        .filter((d) => {
          ...
          return (
            d.expense_amount.toString().toLowerCase().includes(search.toLowerCase()) ||
            d.expense_id.toString().toLowerCase().includes(search.toLowerCase()) ||
            real_expense_date.toLowerCase().includes(search.toLowerCase()) ||
            d.user_full_name.toString().toLowerCase().includes(search.toLowerCase()) ||
            d.expense_description.toLowerCase().includes(search.toLowerCase()) ||
            d.expense_vendor.toString().toLowerCase().includes(search.toLowerCase()) ||
            d.ticket_title.toString().toLowerCase().includes(search.toLowerCase()) ||
            d.expense_approved.toString().toLowerCase().includes(search.toLowerCase())
          );
        })
        .map((d) => {
          console.log(d);
          return (
            <tr>
              ...
              <td>{d.user_full_name}</td>
              <td>{d.ticket_title}</td>
              <td>{d.expense_approved ? <span style={{color:'green'}}> TRUE </span>: <span style={{color:'red'}}> FALSE </span>}</td>
            </tr>
          );
        });
  }
